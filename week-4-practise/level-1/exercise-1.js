...
function displayIntro(writer) {
  return (
    ...
    " I am " +
    writer.age +
    " years old, and works as " +
    writer.occupation
  );
}
finalIntro = writers.map(displayIntro);
console.log(finalIntro); 
...
finalIntro = writers.filter(isAlive).map(displayIntro);
console.log(finalIntro);
